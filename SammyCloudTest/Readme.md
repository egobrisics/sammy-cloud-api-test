...
Once you have edited your template and code you can use the following command lines to deploy your application from the command line (these examples assume the project name is *SammyCloudTest*):
...
Execute unit tests
```
    cd "SammyCloudTest/test/SammyCloudTest.Tests"
    dotnet test
```

Deploy application
```
    cd "SammyCloudTest/src/SammyCloudTest"
