...
Once you have edited your template and code you can use the following command lines to deploy your application from the command line (these examples assume the project name is *SammyCloudAPI*):
...
Execute unit tests
```
    cd "SammyCloudAPI/test/SammyCloudAPI.Tests"
    dotnet test
```

Deploy application
```
    cd "SammyCloudAPI/src/SammyCloudAPI"
